...
export function CompetitionRulesPanel({
  ...
  return <SectionPanel eyebrow="Paso 3" title="Puntuación y desempates" status={<Chip color={stateColor} size="sm" variant="soft">{stateLabel}</Chip>}>
