...
export function CompetitionRulesPanel({
  ...
  return <section className={styles.panel ?? ''} id="competition-rules-shell">
    <SectionPanel eyebrow="Paso 3" id="competition-rules" title="Puntuación y desempates" status={<Chip color={stateColor} size="sm" variant="soft">{stateLabel}</Chip>}>
