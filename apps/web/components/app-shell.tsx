...
const competition: readonly NavEntry[] = [
  ...
  { href: '/standings', icon: 'standings', id: 'standings', label: 'Clasificación' },
  { href: '/general-championship', icon: 'competition', id: 'general-championship', label: 'Campeonato General' },
];
