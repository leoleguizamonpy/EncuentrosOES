...
export function PublicCompetitionClient({ competitionId }: { readonly competitionId: string }): React.JSX.Element {
  ...
  const latestVerificationCode = journey.rounds.at(-1)?.publication.verificationCode;
  return <main id="main-content" className="public-draw-shell">
    ...
    <PrintDocumentFooter documentId={competitionId} verificationCode={latestVerificationCode} />
  </main>;
}
