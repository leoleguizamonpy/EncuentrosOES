...
export function SectionPanel({ children, eyebrow, id, status, title }: SectionPanelProps): React.JSX.Element {
  const headingId = id === undefined ? undefined : `${id}-title`;
  return <Card className={styles.panel} id={id} aria-labelledby={headingId}>
